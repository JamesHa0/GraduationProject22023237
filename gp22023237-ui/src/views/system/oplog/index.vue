         ...
         <el-form :model="form" label-width="100px" class="oplog-detail-form">
            <el-row>
               <el-col :span="12">
                  ...
                  <el-form-item label="登录信息：">{{ form.operName }}（{{ form.operRole }}）/ {{ form.operIp }}</el-form-item>
               </el-col>
               <el-col :span="12">
               ...
               <el-col :span="8">
                  <el-form-item label="操作状态：">
                     ...
                     <div v-else-if="form.status === 1">异常</div>
                  </el-form-item>
               </el-col>
               <el-col :span="8">
...
import { list, delOplog, cleanOplog } from "@/api/system/oplog";
